namespace ServiceDeskPro.Migrations
{
    ...
    public partial class prueba : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Cedula = c.String(),
                        Email = c.String(),
                        DateAdmission = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Asigned = c.Boolean(nullable: false),
                        Resolved = c.Boolean(nullable: false),
                        CommentResolve = c.String()
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Requests", "Usuario_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Requests", new[] { "Usuario_Id" });
